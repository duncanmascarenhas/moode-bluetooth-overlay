...
# 
# DISCLAIMER: This script modifies core Moode Audio UI files (header.php). 
# While it is designed to be safe, it is provided "as is", without warranty of 
# any kind. Use at your own risk. Future Moode updates may overwrite this mod.
# ==============================================================================
